...
export interface SchoolManagementSystem extends BaseContract {
  ...
  getuserSchool: TypedContractMethod<[], [StudentStructOutput[]], "view">;
  ...
  ): TypedContractMethod<[id: BigNumberish], [StudentStructOutput], "view">;
  getFunction(
    nameOrSignature: "getuserSchool"
  ): TypedContractMethod<[], [StudentStructOutput[]], "view">;
  getFunction(
